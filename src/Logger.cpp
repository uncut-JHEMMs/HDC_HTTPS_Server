...
Logger::Logger(std::string filename){
  ...
  */ 
  ...
  void Logger::postMessage(LogMessage& message){
    queueGuard.lock();
    queue.push(message);
    queueGuard.unlock();
    sem_post(&queueSize);
  ...
  void Logger::postType0Message(const std::string& messageText){
  ...
  void Logger::postType0Message(const char* messageText){
    LogMessage message;
  ...
  void Logger::postType1Message(const std::string& messageText){
  ...
  */
  ...
  /*
    ...
    message)
  */
 void Logger::processMessage(LogMessage& message){
  ...
  */
 void Logger::process0message(LogMessage& message){
  ...
  */
 void Logger::process1message(LogMessage& message){
   statsGuard.lock();
  ...
  */
 void Logger::process2message(LogMessage& message){
